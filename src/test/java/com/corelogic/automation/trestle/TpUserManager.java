...
public class TpUserManager extends Wraper{

	private static volatile TpUserManager tpusermanager = null;
	public String stringData = "";
	public Map<String, String> data = null;

	public TpUserManager setStringData(String stringData) {
		this.stringData = stringData;
		return TpUserManager.getInstance();
	}
	
	public TpUserManager setData(Map<String, String> data) {
		this.data = data;
		return TpUserManager.getInstance();
	}

	public static TpUserManager getInstance() {
		if (tpusermanager == null) {
			synchronized (TpUserManager.class) {
				if (tpusermanager == null) {
					tpusermanager = new TpUserManager();
				}
			}
		}
	...
	public void verifyMloUserManager() {
		createNewAdminUser();
	...
	TpNewConnection tpnewconnection= new TpNewConnection();
	...
	public void createNewAdminUser() {
		...
		click("//*[@href='/TP/Account/UserManagerList']", Using.XPATH, TIMEOUT);
		if(isObjectExist("//*[@href='/TP/Account/UserManagerAdd']", Using.XPATH, TIMEOUT)) {
			passLogInfo(methodName, "User is navigated to User Manager page");
			click("//*[@href='/TP/Account/UserManagerAdd']", Using.XPATH, TIMEOUT);
	...
	public void connectWithNewAdminUser() throws Exception {
		
		tpnewconnection.verifyTpNewConnection();
	}
