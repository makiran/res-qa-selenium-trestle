...
public class TpPasswordPage extends Wraper {
	
	private static volatile TpPasswordPage tppasswordpage = null;
	public String stringData = "";
	public Map<String, String> data = null;

	public TpPasswordPage setStringData(String stringData) {
		this.stringData = stringData;
		return TpPasswordPage.getInstance();
	}
	
	public TpPasswordPage setData(Map<String, String> data) {
		this.data = data;
		return TpPasswordPage.getInstance();
	}

	public static TpPasswordPage getInstance() {
		if (tppasswordpage == null) {
			synchronized (TpPasswordPage.class) {
				if (tppasswordpage == null) {
					tppasswordpage = new TpPasswordPage();
				}
			}
		}
		return tppasswordpage;
	}
	public void verifyTpPasswordPage(){
		String methodName="verifyTpPasswordPage";
		click("//*[@id='navbar-collapse']/ul[1]/li[3]/a", Using.XPATH, TIMEOUT);
		click("//*[@href='/TP/Account/ResetPass']", Using.XPATH, TIMEOUT);
